...
void InitTrickNames() {
    ...
    trickNameTable[RG_SKELETON_KEY] = {
        Text{ "Master Key", "Master Key", "Master Key" },
        Text{ "Lock Skip", "Lock Skip", "Lock Skip" },
        Text{ "Door Bypass", "Door Bypass", "Door Bypass" },
    };

    trickNameTable[RG_ABILITY_ISG] = {
        Text{ "Sword Lock", "Sword Lock", "Sword Lock" },
        Text{ "Permanent Slash", "Permanent Slash", "Permanent Slash" },
        Text{ "Frozen Swing", "Frozen Swing", "Frozen Swing" },
    };

    trickNameTable[RG_ABILITY_OI] = {
        Text{ "Bottle Ocarina", "Bottle Ocarina", "Bottle Ocarina" },
        Text{ "IO", "IO", "IO" },
        Text{ "Jug", "Jug", "Jug" },
    };

    trickNameTable[RG_ABILITY_QPA] = {
        Text{ "Instant Stow", "Instant Stow", "Instant Stow" },
        Text{ "Quick Sheathe", "Quick Sheathe", "Quick Sheathe" },
        Text{ "Fast Put-Away", "Fast Put-Away", "Fast Put-Away" },
    };

    trickNameTable[RG_ABILITY_HESS] = {
        Text{ "Hyper Slide", "Hyper Slide", "Hyper Slide" },
        Text{ "Momentum Burst", "Momentum Burst", "Momentum Burst" },
        Text{ "Speed Extension", "Speed Extension", "Speed Extension" },
    };

    trickNameTable[RG_ABILITY_SUPERSLIDE] = {
        Text{ "Power Slide", "Power Slide", "Power Slide" },
        Text{ "Extended Slide", "Extended Slide", "Extended Slide" },
        Text{ "Momentum Slide", "Momentum Slide", "Momentum Slide" },
    };

    trickNameTable[RG_ABILITY_HOVER] = {
        Text{ "Air Stall", "Air Stall", "Air Stall" },
        Text{ "Float Step", "Float Step", "Float Step" },
        Text{ "Midair Pause", "Midair Pause", "Midair Pause" },
    };

    trickNameTable[RG_ABILITY_EQUIP_SWAP] = {
        Text{ "Instant Swap", "Instant Swap", "Instant Swap" },
        Text{ "Item Flip", "Item Flip", "Item Flip" },
        Text{ "Quick Swap", "Quick Swap", "Quick Swap" },
    };

    trickNameTable[RG_ABILITY_GROUND_JUMP] = {
        Text{ "Instant Jump", "Instant Jump", "Instant Jump" },
        Text{ "Ground Hops", "Ground Hops", "Ground Hops" },
        Text{ "Phantom Jump", "Phantom Jump", "Phantom Jump" },
    };

    trickNameTable[RG_ABILITY_WEIRDSHOT] = {
        Text{ "Reverse Shot", "Reverse Shot", "Reverse Shot" },
        Text{ "Back Shot", "Back Shot", "Back Shot" },
        Text{ "Recoil Shot", "Recoil Shot", "Recoil Shot" },
    };
...
Text GetIceTrapName(size_t id) {
    ...
    if (id >= trickNameTable.size()) {
        return Text{ "Ice Trap" };
    }

    auto& names = trickNameTable[id];

    // Guard against empty name lists
    if (names.empty()) {
        return Text{ "Ice Trap" };
    }
