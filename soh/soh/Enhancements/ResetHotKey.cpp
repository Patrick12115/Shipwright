...
static constexpr int32_t CVAR_VOID_BTN_MASK_DEFAULT = 0;
#define CVAR_VOID_BTN_MASK_NAME "gDeveloperTools.VoidBtn"
#define CVAR_VOID_BTN_MASK_VALUE CVarGetInteger(CVAR_VOID_BTN_MASK_NAME, CVAR_VOID_BTN_MASK_DEFAULT)
...
static void OnGameStateMainStartVoidHotkey() {
    const int32_t packed = CVarGetInteger("gDeveloperTools.VoidBtn", 0);
...
static void RegisterResetHotkey() {
    ...
    COND_HOOK(OnGameStateMainStart, true, OnGameStateMainStartVoidHotkey);
}
